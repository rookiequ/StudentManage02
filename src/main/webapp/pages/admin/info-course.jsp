    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/courses/admin-get-all-courses">课程列表</a></li>
                <li class="active">课程详情</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/course/get-course-by-id"
              method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="tag"
                                   placeholder="类型" readonly ="readonly" value="${course.tag==1?'必修':'选修'}">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="teacherId"
                                   placeholder="教师id" readonly ="readonly" value="${course.teacherId}">
                        </div>
