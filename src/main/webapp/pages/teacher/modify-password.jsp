...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/teacher/modify-password"
              method="post">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-12 data">
                            <input type="hidden" class="form-control" name="id"
                                   placeholder="id"  value="${teacherAccount.id}">
                        </div>
                        <div class="col-md-3 data"></div>
                        <div class="col-md-2 title">账号</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="account"
                                   placeholder="账号" readonly ="readonly" value="${teacherAccount.number}">
                        </div>
                        <div class="col-md-3 data"></div>
