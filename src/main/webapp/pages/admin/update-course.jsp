    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/course/get-all-courses">课程列表</a></li>
                <li class="active">修改课程</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/course/update-course"
              method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="id"
                                   placeholder="id" readonly ="readonly" value="${course.id}">
                        </div>
                        <div class="col-md-2 title">课程号</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="number"
                                   placeholder="课程号" readonly ="readonly" value="${course.number}">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <%--<input type="text" class="form-control" name="tag"
                                   placeholder="类型" value="${course.tag}">--%>
                            <%--<label for="${course.tag}">课程类型</label>--%>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="credit"
                                   placeholder="学分" value="${course.credit}">
                        </div>
                        <div class="col-md-2 title">教师ID</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="teacherId"
                                   placeholder="教师id" value="${course.teacherId}">
                        </div>
                        <div class="col-md-2 title">教师</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="teacherName"
                                   placeholder="教师" readonly ="readonly" value="${course.teacherDO.name}">
                        </div>
