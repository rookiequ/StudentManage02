    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/course/get-all-course-by-teacher?teacher_id=${teacherAccount.id}">学生列表</a></li>
                <li class="active">学生详情</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/student/get-student-by-id-teacher"
              method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="name"
                                   placeholder="学生姓名" readonly ="readonly" value="${student.name}">
                        </div>
                        <div class="col-md-2 title">性别</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="sex"
                                   placeholder="学生性别" readonly ="readonly" value="${student.sex}">
                        </div>
                        <div class="col-md-2 title">班级</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="classroom"
                                   placeholder="学生班级" readonly ="readonly" value="${student.classroom}">
                        </div>
                        <div class="col-md-2 title">专业</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="major"
                                   placeholder="学生专业" readonly ="readonly" value="${student.major}">
                        </div>
                        <div class="col-md-2 title">学院</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="college"
                                   placeholder="学生学院" readonly ="readonly" value="${student.college}">
                        </div>
