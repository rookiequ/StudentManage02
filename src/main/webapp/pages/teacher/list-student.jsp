                ...
                <div class="box-footer">
                    ...
                    <div class="col-md-6 text-right">
                        <ul class="pagination">
                            ...
                            <li><a href="${pageContext.request.contextPath}/course/get-all-student-by-teacher?page=${pageInfo.pageNum - 1}&size=${pageInfo.pageSize}&course_id=${courseid}">上一页</a></li>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <li><a href="${pageContext.request.contextPath}/course/get-all-student-by-teacher?page=${pageNum}&size=${pageInfo.pageSize}&course_id=${courseid}">${pageNum}</a></li>
                            </c:forEach>
                            <li><a href="${pageContext.request.contextPath}/course/get-all-student-by-teacher?page=${pageInfo.pageNum + 1}&size=${pageInfo.pageSize}&course_id=${courseid}">下一页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/course/get-all-student-by-teacher?page=${pageInfo.pages}&size=${pageInfo.pageSize}&course_id=${courseid}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
