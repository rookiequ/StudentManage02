                ...
                <div class="box-footer">
                    ...
                    <div class="col-md-6 text-right">
                        <ul class="pagination">
                            ...
                            <li><a href="${pageContext.request.contextPath}/course/get-all-course-by-teacher?page=${pageInfo.pageNum - 1}&size=${pageInfo.pageSize}&teacher_id=${teacherAccount.id}">上一页</a></li>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <li><a href="${pageContext.request.contextPath}/course/get-all-course-by-teacher?page=${pageNum}&size=${pageInfo.pageSize}&teacher_id=${teacherAccount.id}">${pageNum}</a></li>
                            </c:forEach>
                            <li><a href="${pageContext.request.contextPath}/course/get-all-course-by-teacher?page=${pageInfo.pageNum + 1}&size=${pageInfo.pageSize}&teacher_id=${teacherAccount.id}">下一页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/course/get-all-course-by-teacher?page=${pageInfo.pages}&size=${pageInfo.pageSize}&teacher_id=${teacherAccount.id}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
