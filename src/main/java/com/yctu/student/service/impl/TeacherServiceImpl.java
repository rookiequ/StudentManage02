...
public class TeacherServiceImpl implements TeacherService {
    ...
    @Override
    public ResultDO<TeacherDO> getTeacherByNumberAndPassword(String number, String password) {
        //先判断参数是否合法
        ...
        try {
            ...
            if (teacherDO == null){
                return new ResultDO<TeacherDO>(false, ResultCode.NO_SUCH_ACCOUNT, ResultCode.MSG_NO_SUCH_ACCOUNT, null);
            }
            return new ResultDO<TeacherDO>(true, ResultCode.SUCCESS, ResultCode.MSG_SUCCESS, teacherDO);
    ...
    @Override
    public ResultDO<Long> updateTeacherPasswordById(Long id, String newPassword) {
        TeacherDO teacherDO = teacherDAO.getTeacherById(id);
        if (teacherDO == null){
            return new ResultDO<Long>(false, ResultCode.NO_SUCH_TEACHER, ResultCode.MSG_NO_SUCH_TEACHER, null);
        }
        teacherDO.setPassword(SHA256Util.SHA256(newPassword));
        teacherDAO.updateTeacher(teacherDO);
